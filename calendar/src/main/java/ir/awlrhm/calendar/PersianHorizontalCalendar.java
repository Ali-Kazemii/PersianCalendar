...
public class PersianHorizontalCalendar extends LinearLayout implements PageViewListener, AnimationsListener {
    ...
    public DateTime INIT_DATE = new DateTime(PersianChronologyKhayyam.getInstance(DateTimeZone.forTimeZone(TimeZone.getTimeZone("IRAN"))/*forID("Asia/Tehran")*/));
    ...
    protected int dayLablesTextColor = ContextCompat.getColor(getContext(), R.color.blue_800);
    ...
    public PersianHorizontalCalendar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
        setRootLayoutDirection();
    }

    public PersianHorizontalCalendar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public PersianHorizontalCalendar setPersianHorizontalExpCalListener(PersianHorizontalExpCalListener persianHorizontalExpCalListener) {
    ...
    public PersianHorizontalCalendar removeHorizontalExpCalListener() {
    ...
    protected void init(AttributeSet attributeSet) {
        inflate(getContext(), R.layout.awlrhm_persian_horizontal_calendar, this);
    ...
    protected void setupCellWidth() {
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                PersianHorizontalCalendar.this.getViewTreeObserver().removeOnGlobalLayoutListener(this);
    ...
    protected void setupInitialViewFromAttr(TypedArray typedArray) {
        if (typedArray.hasValue(R.styleable.PersianHorizontalExpCalendar_initial_view)) {
            PersianViewPagerType nextView = typedArray.getString(R.styleable.PersianHorizontalExpCalendar_initial_view).equalsIgnoreCase("WEEK") ?
                    PersianViewPagerType.WEEK : PersianViewPagerType.MONTH;
    ...
    protected void initAnimation() {
        animations = new Animations(getContext(), PersianHorizontalCalendar.this, utils.animateContainerExtraTopOffset(getResources()));
    }
    ...
    @Override
    public PersianHorizontalCalendar scrollToDate(DateTime dateTime, boolean scrollMonthPager, boolean scrollWeekPager, boolean animate) {
        if (scrollMonthPager)
    ...
    @Override
    public PersianHorizontalCalendar animateContainerAddView(View view) {
        animateContainer.addView(view);
        return this;
    }

    @Override
    public PersianHorizontalCalendar animateContainerRemoveViews() {
        animateContainer.removeAllViews();
        return this;
    }

    @Override
    public PersianHorizontalCalendar updateMarks() {
    ...
    @Override
    public PersianHorizontalCalendar changeViewPager(PersianViewPagerType persianViewPagerType) {
        if (persianHorizontalExpCalListener != null)
    ...
    @Override
    public PersianHorizontalCalendar onDayClick(DateTime dateTime) {
    ...
    @Override
    public PersianHorizontalCalendar setHeightToCenterContainer(int height) {
    ...
    @Override
    public PersianHorizontalCalendar setTopMarginToAnimContainer(int margin) {
        ((RelativeLayout.LayoutParams) animateContainer.getLayoutParams()).topMargin = margin;
        return this;
    }

    @Override
    public PersianHorizontalCalendar setWeekPagerVisibility(int visibility) {
        weekViewPager.setVisibility(visibility);
        return this;
    }

    @Override
    public PersianHorizontalCalendar setMonthPagerVisibility(int visibility) {
        monthViewPager.setVisibility(visibility);
        return this;
    }

    @Override
    public PersianHorizontalCalendar setAnimatedContainerVisibility(int visibility) {
        animateContainer.setVisibility(visibility);
        return this;
    }

    @Override
    public PersianHorizontalCalendar setMonthPagerAlpha(float alpha) {
        monthViewPager.setAlpha(alpha);
        return this;
    }

    @Override
    public PersianHorizontalCalendar setWeekPagerAlpha(float alpha) {
    ...
    public PersianHorizontalCalendar scrollToDate(DateTime dateTime) {
        return scrollToDate(dateTime, true);
    }

    public PersianHorizontalCalendar scrollToDate(DateTime dateTime, boolean animate) {
    ...
    public PersianHorizontalCalendar setTodayButtonTypeface(Typeface font) {
        todayButton.setTypeface(font);
        return this;
    }


    public PersianHorizontalCalendar setTodayButtonTextColor(int color) {
        todayButton.setTextColor(color);
        return this;
    }

    public PersianHorizontalCalendar setTodayButtonTextSize(float Size) {
        todayButton.setTextSize(Size);
        return this;
    }

    public PersianHorizontalCalendar setTodayButtonBackground(Drawable background) {
        todayButton.setBackground(background);
        return this;
    }

    public PersianHorizontalCalendar setCenterContainerBackground(Drawable background) {
        RelativeLayout container = (RelativeLayout) findViewById(R.id.center_container);
        container.setBackground(background);
        return this;
    }

    public PersianHorizontalCalendar setCenterContainerBackgroundColor(int color) {
        RelativeLayout container = (RelativeLayout) findViewById(R.id.center_container);
        container.setBackgroundColor(color);
        return this;
    }

    public PersianHorizontalCalendar setDayLabelsTextColor(int color) {
        dayLablesTextColor = color;
        return this;
    }

    public PersianHorizontalCalendar setDaysCurrentMonthTextColor(int color) {
        daysTextColorCurrentMonth = color;
        return this;
    }

    public PersianHorizontalCalendar setDaysAnotherMonthTextColor(int color) {
        daysTextColorAnotherMonth = color;
        return this;
    }

    public PersianHorizontalCalendar setDayLabelsTextSize(int size) {
        dayLablesTextSize = size;
        return this;
    }

    public PersianHorizontalCalendar setDaysTextSize(int size) {
        daysTextSize = size;
        return this;
    }

    public PersianHorizontalCalendar setDaysLabelsHorizontalLineVisibility(int visibility) {
        findViewById(R.id.lable_cell_horizontal_line).setVisibility(visibility);
        return this;
    }

    public PersianHorizontalCalendar setDaysLabelsHorizontalLineBackground(Drawable background) {
        findViewById(R.id.lable_cell_horizontal_line).setBackground(background);
        return this;
    }

    public PersianHorizontalCalendar setDaysLabelsHorizontalLineBackgroundColor(int color) {
        findViewById(R.id.lable_cell_horizontal_line).setBackgroundColor(color);
        return this;
    }

    public PersianHorizontalCalendar setDaysLabelsHorizontalLineHeight(int height) {
        View rl = (View) findViewById(R.id.lable_cell_horizontal_line);
        rl.getLayoutParams().height = height;
        return this;
    }

    public PersianHorizontalCalendar expand() {
        if (!ifExpand) {
            lock();
            if (currentViewPager != PersianViewPagerType.MONTH)
    ...
    public PersianHorizontalCalendar collapse() {
        if (ifExpand) {
            if (!isLocked()) {
                lock();
    ...
    public boolean hasMarkDay(DateTime dateTime) {
        MarkSetup mark = marks.getMark(dateTime);
        return (mark.isCustomGradientDrawable() || mark.isSmallOval_Bottom() || mark.isVerticalLine_Right());
    }

    public PersianHorizontalCalendar markToday() {
        marks.markToday();
        return this;
    }

    public PersianHorizontalCalendar setMarkTodayCustomGradientDrawable(CustomGradientDrawable customGradientDrawable) {
        todayCustomGradientDrawableMark = customGradientDrawable;
        return this;
    }

    public PersianHorizontalCalendar setMarkSelectedDateCustomGradientDrawable(CustomGradientDrawable customGradientDrawable) {
        selectedCustomGradientDrawableMark = customGradientDrawable;
        return this;
    }

    public PersianHorizontalCalendar markDate(DateTime dateTime, CustomGradientDrawable drawable) {
        marks.refreshCustomMark(dateTime, PersianCustomMarks.Custom, true, 0, drawable);
        return this;
    }

    public PersianHorizontalCalendar markDate(DateTime dateTime, PersianCustomMarks persianCustomMarks, int color) {
        if (persianCustomMarks != PersianCustomMarks.Custom)
            marks.refreshCustomMark(dateTime, persianCustomMarks, true, color, null);
        return this;
    }

    public PersianHorizontalCalendar markDate(DateTime dateTime, PersianCustomMarks persianCustomMarks) {
        if (persianCustomMarks != PersianCustomMarks.Custom)
    ...
    protected class DayCellView extends BaseCellView {
        ...
        protected void initView() {
            inflate(getContext(), R.layout.awlrhm_day_cell_view, this);
        ...
        protected void setMarkToView() {
            ...
            if (markSetup == null) {
                ...
                if (markSetup.isToday() && is_CurrentTime) {
                    text.setTextColor(ContextCompat.getColor(getContext(), R.color.black)); //today on calendar
    ...
    protected class Marks {
        ...
        public void markToday() {
            if (isLocked())
                return;
            lock();
            MarkSetup markSetup = getMark(new DateTime(PersianChronologyKhayyam.getInstance(/*DateTimeZone.forID("Asia/Tehran")*/DateTimeZone.getDefault())));
            if (markSetup == null)
                addNewMark(new DateTime(PersianChronologyKhayyam.getInstance(/*DateTimeZone.forID("Asia/Tehran")*/DateTimeZone.getDefault())), new MarkSetup(true, false));
            else
    ...
    protected class LabelCellView extends BaseCellView {
        ...
        protected void initView() {
            inflate(getContext(), R.layout.awlrhm_label_cell_view, this);
            text = (TextView) findViewById(R.id.text);
        }
